...
vim.api.nvim_set_keymap('n', '<Leader>cc', ':w<CR>:bo 20sp | term make<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>ct', ':w<CR>:bo 20sp | term cargo test<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>cd', ':w<CR>:bo 20sp | term cargo run<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>cr', ':w<CR>:bo 20sp | term cargo run --release<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>cb', ':w<CR>:bo 20sp | term cargo build --release<CR>', {noremap = true})
